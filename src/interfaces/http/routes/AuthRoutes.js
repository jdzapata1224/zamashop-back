...
router.get('/Google/Callback/:code', (req, res) => googleCallbackController.callback(req, res));
router.get('/Outlook',       (req, res) => outlookRedirectController.getUrl(req, res));
router.get('/Outlook/Callback/:code', (req, res) => outlookCallbackController.callback(req, res));
